...
namespace OrderCloud.Catalyst
{
	public static class EmailBuilder
	{
		...
		public static EmailMessage BuildTemplateEmail(string to, string from, string subject, string templateID, object templateData, List<EmailAttachment> attachments = null)
		{
			return BuildTemplateEmail(new ToEmailAddress(to), new EmailAddress(from), subject, templateID, templateData, attachments);
		}

		public static EmailMessage BuildTemplateEmail(ToEmailAddress to, EmailAddress from, string subject, string templateID, object templateData, List<EmailAttachment> attachments = null)
		{
			var list = new List<ToEmailAddress>() { to };
		...
		public static EmailMessage BuildTemplateEmailToMany(List<string> to, string from, string subject, string templateID, object templateData, List<EmailAttachment> attachments = null)
		{
			var list = to.Select(x => new ToEmailAddress(x)).ToList();
			return BuildTemplateEmailToMany(list, new EmailAddress(from), subject, templateID, templateData, attachments);
		}

		public static EmailMessage BuildTemplateEmailToMany(List<ToEmailAddress> to, EmailAddress from, string subject, string templateID, object templateData, List<EmailAttachment> attachments = null)
		{
		...
		public static EmailMessage BuildSharedThreadTemplateEmailToMany(List<string> to, string from, string subject, string templateID, object templateData, List<EmailAttachment> attachments = null)
		{
			var list = to.Select(x => new EmailAddress(x)).ToList();
			return BuildSharedThreadTemplateEmailToMany(list, new EmailAddress(from), subject, templateID, templateData, attachments);
		}

		public static EmailMessage BuildSharedThreadTemplateEmailToMany(List<EmailAddress> to, EmailAddress from, string subject, string templateID, object templateData, List<EmailAttachment> attachments = null)
		{
			var list = to.Select(x => new ToEmailAddress(x)).ToList();
