namespace Catalyst.Api
{
	...
	public class OrderCloudSettings
	{
		...
		public string MiddlewareClientID { get; set; } // Find this in Ordercloud portal, Api Client resource
		public string MiddlewareClientSecret { get; set; } // Find this in Ordercloud portal, Api Client resource
